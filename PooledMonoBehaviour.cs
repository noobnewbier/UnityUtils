...
namespace UnityUtils
{
    public abstract class PooledMonoBehaviour : MonoBehaviour
    {
        ...
        public GameObject GetPooledInstance()
        {
            ...
            if (_pool == null) _pool = ObjectPool.GetPoolFor(this);

            var toReturn = _pool.GetInstance();
            toReturn.GetComponent<PooledMonoBehaviour>()._pool =
                _pool; //what if the same gameobject have multiple pooledObject
